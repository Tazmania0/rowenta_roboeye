...
def test_wet_support_defaults_false_until_platform_detection():
    """Dev platform detection owns wet-support gating."""
    coordinator = RobEyeCoordinator.__new__(RobEyeCoordinator)
    assert coordinator.has_wet_support is False
    coordinator.has_wet_support = True
