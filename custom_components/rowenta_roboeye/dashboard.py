        ...
        "cards": [
            {
                ...
                "entities": [
                    ...
                    {"type": "attribute", "entity": f"sensor.{_d}_main_brush_runtime", "attribute": "limit", "name": "Main Brush Lifetime", "suffix": " h", "icon": "mdi:timer-outline"},
                    ...
                    {"type": "attribute", "entity": f"sensor.{_d}_side_brush_runtime", "attribute": "limit", "name": "Side Brush Lifetime", "suffix": " h", "icon": "mdi:timer-outline"},
                    ...
                    {"type": "attribute", "entity": f"sensor.{_d}_mop_pad_runtime", "attribute": "limit", "name": "Mop Pad Lifetime", "suffix": " h", "icon": "mdi:timer-outline"},
            ...
            },
            {
                ...
                "entities": [
                    ...
                    {"type": "attribute", "entity": f"sensor.{_d}_main_brush_area_since_clean", "attribute": "limit", "name": "Main Brush Due", "suffix": " m²", "icon": "mdi:alert-circle-outline"},
                    ...
                    {"type": "attribute", "entity": f"sensor.{_d}_side_brush_area_since_clean", "attribute": "limit", "name": "Side Brush Due", "suffix": " m²", "icon": "mdi:alert-circle-outline"},
                    ...
                    {"type": "attribute", "entity": f"sensor.{_d}_dustbin_area_since_empty", "attribute": "limit", "name": "Dustbin Due", "suffix": " m²", "icon": "mdi:alert-circle-outline"},
                    ...
                    {"type": "attribute", "entity": f"sensor.{_d}_filter_area_since_clean", "attribute": "limit", "name": "Filter Due", "suffix": " m²", "icon": "mdi:alert-circle-outline"},
                    ...
                    {"type": "attribute", "entity": f"sensor.{_d}_drop_sensor_area_since_clean", "attribute": "limit", "name": "Drop Sensors Due", "suffix": " m²", "icon": "mdi:alert-circle-outline"},
